...
export const COLOR_MODE_EXPR_BORDER_RADIUS = 4;
export const COLOR_MODE_EXPR_BORDER_WIDTH = 1;
export const COLOR_MODE_EXPR_FONT_SIZE = 12;
export const COLOR_MODE_EXPR_PADDING_X = 6;
export const COLOR_MODE_EXPR_PADDING_Y = 2;
